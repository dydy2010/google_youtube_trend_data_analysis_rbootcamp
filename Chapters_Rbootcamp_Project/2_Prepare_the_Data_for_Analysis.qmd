...
Then why is it an opportunity? Actually after separating the desired iPhone, Tesla and Rolex `tags`, we could even explore what `tags` are around these products. New types of graphs like word cloud could be made.
