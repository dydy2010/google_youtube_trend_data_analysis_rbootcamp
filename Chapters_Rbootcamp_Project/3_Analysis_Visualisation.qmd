...
Third, we investigate hidden patterns through model
analysis, applying a linear regression model to the data. Fourth, we performed a Youtube-specific analysis of brand performance. Last but not
