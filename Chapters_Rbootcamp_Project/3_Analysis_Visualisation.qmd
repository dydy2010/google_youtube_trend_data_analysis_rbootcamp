...
To realize that, 2 versions of the graphs are constructed (180 days next to event). In v1, 2 sections of visualisation were drawn, for youtube and google data. The Y axis are the youtube and google engagement and the X axis are the time spans.
...
*Graph 3 v2: The iPhone Hype Cycle (Google & Youtube separately)*
180-day window around the iPhone X launch.
