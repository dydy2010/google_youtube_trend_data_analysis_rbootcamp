...
## Make the bar chart
ggplot(plot_data, aes(x = month_abbr, y = total_hits)) +
  geom_col(fill = "darkblue") +
  labs(x = "Month", y = "Total Hits", title = "Monthly Hits Summary") +
  scale_x_discrete(drop = FALSE) +
  theme_minimal() +
  labs(
    title = "Rolex searches worldwide by month",
    x = "Month",
    y = "Searches",
    caption = "Source: Google Trends (November 2017 to Juin 2018)"
  )
